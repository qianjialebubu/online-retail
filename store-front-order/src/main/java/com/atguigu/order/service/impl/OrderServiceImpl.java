...
import com.atguigu.pojo.OrderVo;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    public R save(OrderParam orderParam) {
        ...
        //商品修改库存参数集合
        List<OrderToProduct>  productNumberParamList  = new ArrayList<>();
        ...
        for (CartVo cartVo : products) {
            ...
            productNumberParamList.add(orderToProduct); //添加集合
        }
        //批量数据插入//
     ...
     */
    @Override
    public R list(Integer orderParam) {
        Integer userId = orderParam;
        if(userId == null){
            return R.fail("购物车没有商品，请添加后购买");
        }
        //查询用户对应的全部订单数据
